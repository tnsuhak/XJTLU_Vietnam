...
def render_news_index(data: dict, items: list[dict]) -> None:
    ...
    for pos, item in enumerate(items, start=1):
        ...
        item_list.append({
            ...
            "name": item.get("title") or "XJTLU News",
        })
        ...
        "@graph": [
            {
                ...
                "url": BASE + "news/",
                "name": "Tin tức XJTLU | XJTLU Việt Nam",
                "description": "Tin tức và cập nhật chính thức từ XJTLU, được chọn lọc và tóm tắt bằng tiếng Việt cho học sinh và phụ huynh Việt Nam.",
                "inLanguage": "vi-VN",
            },
            {
                "@type": "ItemList",
                "name": "Tin tức XJTLU dành cho Việt Nam",
